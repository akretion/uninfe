...
namespace NFe.Components.HJaboataoDosGuararapesPE_TINUS_ConsultarLoteRps {
    ...
    public partial class ConsultarLoteRps : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ConsultarLoteRps2OperationCompleted;
        ...
        /// <remarks/>
        public event ConsultarLoteRps2CompletedEventHandler ConsultarLoteRps2Completed;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www2.tinus.com.br/WSNFSE.ConsultarLoteRps.ConsultarLoteRps2", RequestNamespace="http://www2.tinus.com.br", ResponseNamespace="http://www2.tinus.com.br", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public ConsultarLoteRpsResposta ConsultarLoteRps2(ConsultarLoteRpsEnvio Arg2) {
            object[] results = this.Invoke("ConsultarLoteRps2", new object[] {
                        Arg2});
            return ((ConsultarLoteRpsResposta)(results[0]));
        }
        
        /// <remarks/>
        public void ConsultarLoteRps2Async(ConsultarLoteRpsEnvio Arg2) {
            this.ConsultarLoteRps2Async(Arg2, null);
        }
        
        /// <remarks/>
        public void ConsultarLoteRps2Async(ConsultarLoteRpsEnvio Arg2, object userState) {
            if ((this.ConsultarLoteRps2OperationCompleted == null)) {
                this.ConsultarLoteRps2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnConsultarLoteRps2OperationCompleted);
            }
            this.InvokeAsync("ConsultarLoteRps2", new object[] {
                        Arg2}, this.ConsultarLoteRps2OperationCompleted, userState);
        }
        
        private void OnConsultarLoteRps2OperationCompleted(object arg) {
            if ((this.ConsultarLoteRps2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ConsultarLoteRps2Completed(this, new ConsultarLoteRps2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void ConsultarLoteRps2CompletedEventHandler(object sender, ConsultarLoteRps2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ConsultarLoteRps2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ConsultarLoteRps2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
