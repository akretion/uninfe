...
using NFe.Components.PIpojucaPE_TINUS_CancelarNfse;
using NFe.Components.PIpojucaPE_TINUS_ConsultarLoteRps;
using NFe.Components.PIpojucaPE_TINUS_ConsultarNfse;
using NFe.Components.PIpojucaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.PIpojucaPE_TINUS_ConsultarSituacaoLoteRps;
using NFe.Components.PIpojucaPE_TINUS_RecepcionarLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;

namespace NFe.Components.Tinus.IpojucaPE.p
{
