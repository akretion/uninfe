...
using NFe.Components.HIpojucaPE_TINUS_CancelarNfse;
using NFe.Components.HIpojucaPE_TINUS_RecepcionarLoteRps;
using NFe.Components.HIpojucaPE_TINUS_ConsultarNfse;
using NFe.Components.HIpojucaPE_TINUS_ConsultarLoteRps;
using NFe.Components.HIpojucaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.HIpojucaPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;

namespace NFe.Components.Tinus.IpojucaPE.h
{
