...
using NFe.Components.POlindaPE_TINUS_CancelarNfse;
using NFe.Components.POlindaPE_TINUS_ConsultarLoteRps;
using NFe.Components.POlindaPE_TINUS_ConsultarNfse;
using NFe.Components.POlindaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.POlindaPE_TINUS_ConsultarSituacaoLoteRps;
using NFe.Components.POlindaPE_TINUS_RecepcionarLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using System.Text;

namespace NFe.Components.Tinus.OlindaPE.p
{
