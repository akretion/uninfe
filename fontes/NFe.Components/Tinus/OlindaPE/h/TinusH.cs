...
using NFe.Components.HOlindaPE_TINUS_CancelarNfse;
using NFe.Components.HOlindaPE_TINUS_RecepcionarLoteRps;
using NFe.Components.HOlindaPE_TINUS_ConsultarNfse;
using NFe.Components.HOlindaPE_TINUS_ConsultarLoteRps;
using NFe.Components.HOlindaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.HOlindaPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;

namespace NFe.Components.Tinus.OlindaPE.h
{
