...
using NFe.Components.HPaulistaPE_TINUS_CancelarNfse;
using NFe.Components.HPaulistaPE_TINUS_RecepcionarLoteRps;
using NFe.Components.HPaulistaPE_TINUS_ConsultarNfse;
using NFe.Components.HPaulistaPE_TINUS_ConsultarLoteRps;
using NFe.Components.HPaulistaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.HPaulistaPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;

namespace NFe.Components.Tinus.PaulistaPE.h
{
