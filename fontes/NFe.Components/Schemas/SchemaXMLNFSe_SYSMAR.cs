...
{
    public class SchemaXMLNFSe_SYSMAR
    {
        public static void CriarListaIDXML()
        {
            #region XML de lote RPS

            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\SYSMAR\\nfse v2 02.xsd",
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-EnviarLoteRpsSincronoEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-CancelarNfseEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-ConsultarLoteRpsEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-ConsultarNfseRpsEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-ConsultarNfseFaixaEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-GerarNfseEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\SYSMAR\\nfse v2 02.xsd",
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-SubstituirNfseEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SYSMAR-ConsultarNfseServicoTomadoEnvio", new InfSchema()
            {
