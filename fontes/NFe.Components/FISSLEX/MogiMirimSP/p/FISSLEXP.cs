...
using NFe.Components.PMogiMirimSPConsultaLoteRps;
using NFe.Components.PMogiMirimSPConsultaNfse;
using NFe.Components.PMogiMirimSPConsultaNfsePorRps;
using NFe.Components.PMogiMirimSPConsultarSituacaoLoteRps;
using System;
using System.Net;
using System.Reflection;
using System.Xml;

namespace NFe.Components.FISSLEX.MogiMirimSP.p
{
    public class FISSLEXP : EmiteNFSeBase
    {
        ...
        public override void ConsultarLoteRps(string file)
        {
            ...
            NFe.Components.PMogiMirimSPConsultaLoteRps.tcMensagemRetorno[] result = null;
        ...
        public override void ConsultarNfse(string file)
        {
            ...
            PMogiMirimSPConsultaNfse.tcMensagemRetorno[] result = null;
            string strResult = "";
        ...
        public override void ConsultarNfsePorRps(string file)
        {
            ...
            PMogiMirimSPConsultaNfsePorRps.tcMensagemRetorno[] result = null;
            ...
            try
            {
                foreach (XmlNode n in node.ChildNodes)
                {
                    ...
                    if (n.HasChildNodes && n.FirstChild.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            PMogiMirimSPConsultaNfse.tcIdentificacaoTomador instances = new PMogiMirimSPConsultaNfse.tcIdentificacaoTomador();
                            instance = instances.CpfCnpj = new tcCpfCnpj();
                        }
                        else if (tag.Equals("IntermediarioServico") && n.Name.Equals("CpfCnpj"))
                        {
                            PMogiMirimSPConsultaNfse.tcIdentificacaoIntermediarioServico instances = new PMogiMirimSPConsultaNfse.tcIdentificacaoIntermediarioServico();
                            instance = instances.CpfCnpj = new tcCpfCnpj();
                        }
                        else
                            instance =
        ...
        private string GetNameClass(string tag)
        {
            ...
            switch (tag)
            {
                case "ConsultarLoteRpsEnvio":
                    result = "NFe.Components.PMogiMirimSPConsultaLoteRps.";
                    break;

                case "ConsultarSituacaoLoteRpsEnvio":
                    result = "NFe.Components.PMogiMirimSPConsultarSituacaoLoteRps.";
                    break;

                case "ConsultarNfseEnvio":
                    result = "NFe.Components.PMogiMirimSPConsultaNfse.";
                    break;

                case "ConsultarNfseRpsEnvio":
                    result = "NFe.Components.PMogiMirimSPConsultaNfsePorRps.";
                    break;
