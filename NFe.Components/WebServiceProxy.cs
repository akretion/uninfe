                ...
                for (int j = 0; j < urlList[i].ChildNodes.Count; ++j)
                {
                    ...
                    switch (urlList[i].ChildNodes[j].Name)
                    {
                        case "NFeCancelamento":
                            wsItem.NFeCancelamento = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeConsulta":
                            wsItem.NFeConsulta = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeConsultaCadastro":
                            wsItem.NFeConsultaCadastro = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeInutilizacao":
                            wsItem.NFeInutilizacao = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeRecepcao":
                            wsItem.NFeRecepcao = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeRetRecepcao":
                            wsItem.NFeRetRecepcao = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeStatusServico":
                            wsItem.NFeStatusServico = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeConsulta1":
                            wsItem.NFeConsulta1 = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "NFeCCe":
                            wsItem.NFeCCe = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "RecepcionarLoteRps":
                            wsItem.RecepcionarLoteRps = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "ConsultarSituacaoLoteRps":
                            wsItem.ConsultarSituacaoLoteRps = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "ConsultarNfsePorRps":
                            wsItem.ConsultarNfsePorRps = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "ConsultarNfse":
                            wsItem.ConsultarNfse = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "ConsultarLoteRps":
                            wsItem.ConsultarLoteRps = AppPath + urlList[i].ChildNodes[j].InnerText;
                            break;
                        case "CancelarNfse":
