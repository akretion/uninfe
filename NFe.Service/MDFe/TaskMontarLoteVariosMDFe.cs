...
namespace NFe.Service
{
    ...
    public class TaskMontarLoteVariasMDFe : TaskAbst
    {
        ...
        public override void Execute()
        {
            ...
            arquivosNFe = oAux.ArquivosPasta(Empresa.Configuracoes[emp].PastaEnvioEmLote, "*" + Propriedade.ExtEnvio.MDFe);
                ...
                try
                {
                    try
                    {
                        ...
                        foreach (XmlNode documentoNode in documentoList)
                        {
                            ...
                            {
                                string arquivoNFe = Empresa.Configuracoes[emp].PastaEnvioEmLote + Propriedade.NomePastaXMLAssinado + "\\" + documentoElemento.GetElementsByTagName("ArquivoMDFe")[d].InnerText;
