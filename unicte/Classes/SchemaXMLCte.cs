...
namespace unicte
{
    class SchemaXMLCte
    {
        public static void CriarListaIDXML()
        {
            ...
            SchemaXML.lstXMLSchema.Add("procCTe_v1.02.xsd");
            ...
            SchemaXML.lstXMLSchema.Add("procCancCTe_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("procInutCTe_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("cte_v1.02.xsd");
            ...
            SchemaXML.lstXMLSchema.Add("enviCte_v1.02.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("cancCte_v1.01.xsd");
            ...
            SchemaXML.lstXMLSchema.Add("inutCte_v1.01.xsd");
            ...
            SchemaXML.lstXMLSchema.Add("consSitCte_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("consReciCte_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("consStatServCte_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
            ...
            SchemaXML.lstXMLSchema.Add("consCad_v1.01.xsd");
            SchemaXML.lstXMLTagAssinar.Add(string.Empty);
            #endregion
        }
    }
